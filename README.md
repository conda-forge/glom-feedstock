...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/glom-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7731&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/glom-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `glom` can be installed with:

```
conda install glom
```

It is possible to list all of the versions of `glom` available on your platform with:
